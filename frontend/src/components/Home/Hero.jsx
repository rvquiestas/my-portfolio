      ...
      <Container>
        <main className="flex flex-col md:flex-row items-center max-md:text-center justify-between sm:mt-0 md:mt-24 pb-16">
          <div className="flex flex-col items-center md:items-start">
            <span className="mt-16 mb-6 flex items-center space-x-2 border border-[#187DDB] text-[#187DDB] text-xs rounded-full px-4 pr-1.5 py-1.5">
              <Circle size={16} fill='#187DDB' className='mr-2'/>
              AVAILABLE FOR WORK
            </span>
